namespace LogProject.Forms
{
    partial class MainForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            flowLayoutPanel1.Size = new Size(756, 651);
            ...
            // btnAddAreaPoint
            // 
            btnAddAreaPoint.Font = new Font("Times New Roman", 11.25F, FontStyle.Regular, GraphicsUnit.Point);
            btnAddAreaPoint.Location = new Point(611, 13);
            btnAddAreaPoint.Margin = new Padding(3, 4, 3, 4);
            btnAddAreaPoint.Name = "btnAddAreaPoint";
            btnAddAreaPoint.Size = new Size(159, 52);
            btnAddAreaPoint.TabIndex = 6;
            btnAddAreaPoint.Text = "Создать точку площади";
            btnAddAreaPoint.UseVisualStyleBackColor = true;
            btnAddAreaPoint.Visible = false;
            btnAddAreaPoint.Click += btnAddAreaPoint_Click;
            // 
            // MainForm
            // 
            AutoScaleDimensions = new SizeF(8F, 20F);
            AutoScaleMode = AutoScaleMode.Font;
            ClientSize = new Size(782, 737);
            Controls.Add(btnAddAreaPoint);
        ...
        private Button btnAddAreaPoint;
    }
}